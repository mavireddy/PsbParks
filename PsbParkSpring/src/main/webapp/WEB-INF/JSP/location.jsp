...
<body>
	...
	<div></div>
	<div>
		<header class="w3-container  w3-red w3-border-pale-red w3-center "
		...
		<div class="w3-row-padding w3-center w3-container"
			...
			<div class="w3-content">
				<div class="w3-twothird">
					<h1>
						<br>PSBusiness Parks</br>
					</h1>
					<h2>Our business is helping your business grow.</h2>
					<!--       <h5 class="w3-padding-32">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</h5>
 -->
					<p class="w3-text-grey">Business parks in great locations
						offering office/warehouse, industrial and traditional office
						space. Easily navigate available properties and information to
						save you time. Onsite leasing and management teams are ready to
		...
		<div class="w3-row-padding w3-light-grey  w3-container">
			<div class="w3-content">
				...
				<div class="w3-twothird">
					<h1>
						<br>Customer Center</br>
					</h1>
					<h2>888-782-6110</h2>

					<p class="w3-text-grey">The PS Business Parks Customer Center
						provides an easy way to access the payment center, leave comments
						and questions, or view frequently asked questions. Our online
						payment center is easy to use and is the best option for
						last-minute payments. Are we doing a great job or can we do
						better? Leave your feedback and let us know. View FAQs to get
						quick answers to your questions.</p>
				</div>
			</div>
		</div>

		...
		<div class="w3-content w3-red w3-container w3-white">
			<div class="w3-twothird w3-white">
				...
				<h4 class="tenant w3-row-padding w3-white">
					...
					<div>
						<h3 class='w3-container  w3-center  w3-red loc'>Location :
							${Location.location}</h3>
					</div>

					<div class="w3-container location ">

						Address : ${Location.address.addr_line1}<br> City :
						${Location.address.city}<br> State :
						${Location.address.state}<br> Zipcode:
						${Location.address.zipcode}<br> Email Id :
						${Location.contact.email_id}<br> Contact Number :
						${Location.contact.phone_number}<br>
					</div>
				</h4>
